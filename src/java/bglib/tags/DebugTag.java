...
public class DebugTag extends TagSupport {
    ...
    private static final String BEAN_ATTR = "bglib.util.DebugBean";
    private String type;
    ...
    public void setCssKey(String key) {
        this.cssKey = key;
    }

    public void setCssValue(String value) {
        this.cssValue = value;
    }
    /**
    ...
    private String toHTMLTable(String propName, Map values) {
        ...
        if (cssKey != null && cssValue != null) {
            tableSB.append(cssKey+"=\"" + cssValue+"\"");
        }
        tableSB.append(">");
