...
import tds.golf.scripts.DefaultSalaryValue;
import tds.main.bo.*;
...
public class golfCalculateSalaryValuesAction extends BaseAction {
...
//            prefix = "commissioner/golf/";
        ...
        nextPage = prefix + "golfCalculateSalaryValues";
        ...
        try {
            ...
            if ("hfRecalcTrue".equals(recalc)) {
                ...
                try {
                    ...
                    field.run(tournamentID, fsSeasonWeekID);
                } catch (Exception e) {
                    e.printStackTrace();
                }
