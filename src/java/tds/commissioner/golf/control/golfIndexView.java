...
public class golfIndexView extends BaseCommissionerView {
...
//        int reqSportId = FSUtils.getIntRequestParameter(request, "spid", Sport.PRO_FOOTBALL);
...
//                request.setAttribute("marchMadnessGames",MarchMadnessGame.GetTournamentGames(MarchMadnessTournament.GetCurrentTournament().getTournamentID(), +
//                        displayWeek.getWeekNo(), displayWeek.getWeekNo()));
//            }
//
