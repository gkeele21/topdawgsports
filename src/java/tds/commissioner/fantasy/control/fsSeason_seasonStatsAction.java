...
import tds.fantasy.scripts.FootballStats;
...
public class fsSeason_seasonStatsAction extends BaseAction {
        ...
        try {
            ...
            if ("hfUpdateTrue".equals(update)) {
                ...
                try {
                    ...
                    System.out.println("Calling run to total each player's season stats...");
                    stats.insertIntoTotalFootballStats(Season._CurrentSeasonID,1);
                    System.out.println("Done Totalling Season Stats.");
                } catch (Exception e) {
                    e.printStackTrace();
                }
