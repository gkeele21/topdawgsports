...
public class FSSeasonWeek implements Serializable {
    ...
    private LocalDateTime _StartersDeadline;
    private LocalDateTime _TransactionDeadline;
    private LocalDateTime _StartPlayDate;
    private LocalDateTime _EndPlayDate;
    ...
    public LocalDateTime getStartersDeadline() {return _StartersDeadline;}
    public LocalDateTime getTransactionDeadline() {return _TransactionDeadline;}
    public LocalDateTime getStartPlayDate() {return _StartPlayDate;}
    public LocalDateTime getEndPlayDate() {return _EndPlayDate;}
    ...
    public void setStartersDeadline(LocalDateTime StartersDeadline) {_StartersDeadline = StartersDeadline;}
    public void setTransactionDeadline(LocalDateTime TransactionDeadline) {_TransactionDeadline = TransactionDeadline;}
    public void setStartPlayDate(LocalDateTime StartPlayDate) {_StartPlayDate = StartPlayDate;}
    public void setEndPlayDate(LocalDateTime EndPlayDate) {_EndPlayDate = EndPlayDate;}
    ...
    public boolean GetStartersDeadlineHasPassed() {
        LocalDateTime deadline = getStartersDeadline();
    ...
    private void Insert() {
        ...
        sql.append(FSUtils.InsertDBFieldValue((getStartersDeadline()) == null ? null : Application._DATE_TIME_FORMATTER.format(getStartersDeadline()), true));
        sql.append(FSUtils.InsertDBFieldValue((getTransactionDeadline()) == null ? null : Application._DATE_TIME_FORMATTER.format(getTransactionDeadline()), true));
        sql.append(FSUtils.InsertDBFieldValue((getStartPlayDate()) == null ? null : Application._DATE_TIME_FORMATTER.format(getStartPlayDate()), true));
        sql.append(FSUtils.InsertDBFieldValue((getEndPlayDate()) == null ? null : Application._DATE_TIME_FORMATTER.format(getEndPlayDate()), true));
    ...
    private void Update() {
        ...
        sql.append(FSUtils.UpdateDBFieldValue("StartersDeadline", (getStartersDeadline() == null) ? null : Application._DATE_TIME_FORMATTER.format(getStartersDeadline()), true));
        sql.append(FSUtils.UpdateDBFieldValue("TransactionDeadline", (getTransactionDeadline() == null) ? null : Application._DATE_TIME_FORMATTER.format(getTransactionDeadline()), true));
        sql.append(FSUtils.UpdateDBFieldValue("StartPlayDate", (getStartPlayDate() == null) ? null : Application._DATE_TIME_FORMATTER.format(getStartPlayDate()), true));
        sql.append(FSUtils.UpdateDBFieldValue("EndPlayDate", (getEndPlayDate() == null) ? null : Application._DATE_TIME_FORMATTER.format(getEndPlayDate()), true));
